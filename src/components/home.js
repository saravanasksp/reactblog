                ...
                <div className="container">
                    <div className="row g-4">
                        <div className="col-lg-6">
                            <div className="card card-overlay-bottom card-grid-lg card-bg-scale" style={{backgroundImage: `url(${BannerBgImg1})`, backgroundPosition: "center left", backgroundSize: "cover"}}>
                                ...
                                <div className="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
                                    <div className="w-100 mt-auto">
                                        <a href="#0" className="badge text-bg-danger mb-2"><FontAwesomeIcon className="me-2 small fw-bold" icon={faCircle} />Lifestyle</a>
                                        <h2 className="text-white h1"><Link to="/blog-detail" className="btn-link stretched-link text-reset">Ten tell-tale signs you need to get a new startup.</Link></h2>
                                            ...
                                            <li className="nav-item">
                                                <div className="nav-link">
                                                    <div className="d-flex align-items-center text-white position-relative">
                                                        ...
                                                        <span className="ms-3">by <a href="#0" className="stretched-link text-reset btn-link">Louis</a></span>
                                                    </div>
                                                </div>
                                            </li>
                        ...
                        <div className="col-lg-6">
                            <div className="row g-4">
                                <div className="col-12">
                                    <div className="card card-overlay-bottom card-grid-sm card-bg-scale" style={{backgroundImage: `url(${BannerBgImg1})`, backgroundPosition: "center left", backgroundSize: "cover"}}>
                                        <div className="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
                                            <div className="w-100 mt-auto">
                                                <a href="#0" className="badge text-bg-warning mb-2"><FontAwesomeIcon className="me-2 small fw-bold" icon={faCircle} />Technology</a>
                                                <h4 className="text-white"><Link to="/blog-detail" className="btn-link stretched-link text-reset">Best Pinterest boards for learning about business</Link></h4>
                                                <ul className="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                                    <li className="nav-item position-relative">
                                                        <div className="nav-link">by <a href="#0" className="stretched-link text-reset btn-link">Bryan</a>
                                                        </div>
                                                    </li>
                                ...
                                <div className="col-md-6">
                                    <div className="card card-overlay-bottom card-grid-sm card-bg-scale" style={{backgroundImage: `url(${BannerBgImg1})`, backgroundPosition: "center left", backgroundSize: "cover"}}>
                                        <div className="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
                                            <div className="w-100 mt-auto">
                                               <a href="#0" className="badge text-bg-success mb-2"><FontAwesomeIcon className="me-2 small fw-bold" icon={faCircle} />Business</a>
                                                <h4 className="text-white"><Link to="/blog-detail" className="btn-link stretched-link text-reset">Five intermediate guide to business</Link></h4>
                                                <ul className="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                                    <li className="nav-item position-relative">
                                                        <div className="nav-link">by <a href="#0" className="stretched-link text-reset btn-link">Joan</a>
                                                        </div>
                                                    </li>
                                ...
                                <div className="col-md-6">
                                    <div className="card card-overlay-bottom card-grid-sm card-bg-scale" style={{backgroundImage: `url(${BannerBgImg1})`, backgroundPosition: "center left", backgroundSize: "cover"}}>
                                        <div className="card-img-overlay d-flex align-items-center p-3 p-sm-4"> 
                                            <div className="w-100 mt-auto">
                                                <a href="#0" className="badge text-bg-info mb-2"><FontAwesomeIcon className="me-2 small fw-bold" icon={faCircle} />Sports</a>
                                                <h4 className="text-white"><Link to="/blog-detail" className="btn-link stretched-link text-reset">15 reasons to choose startup</Link></h4>
                                                <ul className="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                                    <li className="nav-item position-relative">
                                                        <div className="nav-link">by <a href="#0" className="stretched-link text-reset btn-link">Amanda</a>
                                                        </div>
                                                    </li>
